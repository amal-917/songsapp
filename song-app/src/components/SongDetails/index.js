...
import {MdFavorite,GrFavorite,IoMdArrowRoundBack, HiStatusOnline} from 'react-icons/all'
import './index.css'
        ...
        <div className="details-container">
            ...
            <div className="song-details">
                ...
                <div className="title">
                    ...
                    <div>
                    {one.favorited ? <MdFavorite className="red size-love"/> : <GrFavorite className="size-love"/>}
                    </div>
                    <div className="styling-fav">
                    {one.new && "New"}
                    </div>
                    <div className="styling-fav">
                    {one.trending && "Trending"}
                    </div>
                    </div>
                </div>
            ...
            <div className="similar-container">
                ...
                {Song.filter(each => ( each.artist === one.artist)).map(each => (
                    <Link to= {{pathname:`/${each.name}` , state : {one: each},}} className="link" key={uuid()}>
